...
const Footer = () => {
  return (
    <>
      <CustomDiv className="lg:p-6 border-y border-zinc-200  bg-white ">
        <CustomDiv className="px-10 hidden lg:grid-cols-5 lg:justify-start lg:grid justify-center text-center lg:text-start mx-auto gap-x-3 gap-y-8 ">
          <CustomDiv className="flex flex-col space-y-4">
            <img src={logo} alt="" className="w-36" />
            <CustomDiv className="flex flex-col  space-y-2 text-sm">
          ...
          <CustomDiv className="flex flex-col space-y-4">
            <Text className="font-bold">Help</Text>
            <CustomDiv className="flex flex-col space-y-2 text-sm">
              <Link to="#" rel="noopener noreferrer">
                <Text>Utility-First</Text>
              </Link>
              <Link to="#" rel="noopener noreferrer">
                <Text> Responsive Design</Text>
              </Link>
              <Link to="#" rel="noopener noreferrer">
                <Text> Hover, Focus, Other States</Text>
              </Link>
              <Link to="#" rel="noopener noreferrer">
                <Text> Dark Mode</Text>
              </Link>
              <Link to="#" rel="noopener noreferrer">
                <Text> Adding Base Styles</Text>
              </Link>
              <Link to="#" rel="noopener noreferrer">
                <Text> Extracting Components</Text>
              </Link>
              <Link to="#" rel="noopener noreferrer">
                <Text> Adding New Utilities</Text>
              </Link>
            </CustomDiv>
          </CustomDiv>
          <CustomDiv className="flex flex-col space-y-4">
            <Text className="font-bold">Inspire Me</Text>
            <CustomDiv className="flex flex-col space-y-2 text-sm">
              <Link to="#" rel="noopener noreferrer">
              ...
              <Link to="#" rel="noopener noreferrer">
                <Text> Customizing Colors</Text>
              </Link>
              <Link to="#" rel="noopener noreferrer">
                <Text> Customizing Spacing</Text>
              </Link>
              <Link to="#" rel="noopener noreferrer">
                <Text> Configuring Variants</Text>
              </Link>
              <Link to="#" rel="noopener noreferrer">
                <Text> Plugins</Text>
              </Link>
          ...
          <div className="space-y-3">
            ...
            <div className="flex lg:justify-start justify-center space-x-3">
              <Link
                to="https://www.facebook.com/amakaind/"
      ...
      <CustomDiv className="flex flex-col gap-3 px-3 bg-white py-3">
        <img src={amaka} alt="" className="scale-75 block lg:hidden" />
        ...
        <CustomDiv className="flex gap-5 justify-center text-center">
          <Text className="">
            ©2023 Amaka Industries Pvt. Ltd. All Rights Reserved.
          </Text>
        </CustomDiv>
      </CustomDiv>
    </>
